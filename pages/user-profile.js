                                        ...
                                        <div className="card-body">
                                            <div className="row">
                                                ...
                                                <p><Icon.ArrowsVertical  /> Height: {editingAthletic ? <input type="number" placeholder="Enter height in cm" value={user.height || ''} onChange={(e) => setUser({ ...user, height: e.target.value })} style={{ width: '80px', marginLeft: '8px' }} /> : `${user.height || 'N/A'} cm`}</p>
                                                    ...
                                                    <p><Icon.Wind /> 40 Yard Dash: {editingAthletic ? <input type="number" placeholder="Enter time in seconds" value={user.forty || ''} onChange={(e) => setUser({ ...user, forty: e.target.value })} style={{ width: '120px', marginLeft: '8px' }} /> : `${user.forty || 'N/A'} seconds`}</p>
                                                    <p><Icon.Target /> 40 Yard Dash (Laser): {editingAthletic ? <input type="number" placeholder="Enter time in seconds" value={user.fortyLazer || ''} onChange={(e) => setUser({ ...user, fortyLazer: e.target.value })} style={{ width: '120px', marginLeft: '8px' }} /> : `${user.fortyLazer || 'N/A'} seconds`}</p>
                                                    ...
                                                    <p><Icon.ArrowUp /> Vertical Jump: {editingAthletic ? <input type="number" placeholder="Enter height in inches" value={user.vertical || ''} onChange={(e) => setUser({ ...user, vertical: e.target.value })} style={{ width: '120px', marginLeft: '8px' }} /> : `${user.vertical || 'N/A'} inches`}</p>
                                                    <p><Icon.ArrowRight /> Broad Jump: {editingAthletic ? <input type="number" placeholder="Enter distance in inches" value={user.broadJump || ''} onChange={(e) => setUser({ ...user, broadJump: e.target.value })} style={{ width: '120px', marginLeft: '8px' }} /> : `${user.broadJump || 'N/A'} inches`}</p>
                                                </div>
